...
export const INSTRUMENTS: Instrument[] = [
  ...
  { id: "US100", name: "NASDAQ 100 (NQ)", category: "index", quote: "USD", twelveData: "NDX", fmp: "^NDX", valuePerPoint: 20, tick: 0.25, primary: true },
  { id: "SPX", name: "S&P 500 (ES)", category: "index", quote: "USD", twelveData: "SPX", fmp: "^GSPC", valuePerPoint: 50, tick: 0.25, primary: true },
  ...
  { id: "USOIL", name: "WTI Crude Oil (US Oil)", category: "energy", quote: "USD", twelveData: "WTI/USD", fmp: "CLUSD", valuePerPoint: 1000, tick: 0.01 },
];
